...
fun PermissionBox(
    ...
    val permissionState = rememberMultiplePermissionsState(permissions = permissions) { map ->
        ...
        errorText = if (rejectedPermissions.none { it in requiredPermissions }) {
            ...
            "${rejectedPermissions.joinToString()} required for the Current Location"
        }
    }
...
//        Text(
//            text = "Parking Spot App requires permissions:",
...
//            Text(text = "Grant permissions")
    ...
    if (showRationale) {
        AlertDialog(
            ...
            text = {
                Text(text = "Parking Spot app requires the following permissions to work:\n $permissions")
            },
            confirmButton = {
                TextButton(
                    onClick = {
